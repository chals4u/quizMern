        ...
        axios
            ...
            .then(response => {
                this.setState({
                    ...
                    answers: [  response.data[count].answers[0], 
                                response.data[count].answers[1], 
                                response.data[count].answers[2], 
                                response.data[count].answers[3] 
                            ],
                    correct: response.data[count].correct,
